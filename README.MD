...
Spin up a local environment on Linux, Mac, and Windows using CLI command <strong>docker-env</strong>.
...
└── bedrock               # Bedrock sites
└── php                   # PHP-Server sites
└── nextjs                # Next.js sites
```
